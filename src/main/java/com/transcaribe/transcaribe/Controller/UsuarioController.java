...
public class UsuarioController {
    ...
    public String menu(Model model) {
        ...
        if (!usuario.isVerificado()) return "redirect:/verificar-otp?correo=" + usuario.getCorreo();
    ...
    @PostMapping("/perfil")
    public String actualizarPerfil(@RequestParam String nombre, @RequestParam String correo, @RequestParam(required = false) String password, Model model) {
        ...
        model.addAttribute("usuario", usuarioRepository.findById(usuarioActual.getId()).orElse(usuarioActual));
        return "perfil";
    }
